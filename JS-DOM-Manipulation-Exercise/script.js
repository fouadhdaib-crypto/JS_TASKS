...
function updateCounter(Counter) {
   ...
   counterElment = document.getElementById("counter");
   counterElment.textContent = Counter+" task(s) remaining";

   if(Counter==0){
     const  empty_msgP = document.getElementById("empty-msg");
     empty_msgP.classList="";
...
/* ============================================================
   ...
   /* const Task =  taskInput.value;
     ...
     span.classList="task-text";
         ...
         const DeleteBtn = document.createElement("button");
         DeleteBtn.textContent="Remining"
...
clear_done.addEventListener("click",function(event){
